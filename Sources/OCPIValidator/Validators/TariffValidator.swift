...
public struct TariffValidator {
    ...
    public func validate(_ jsonData: Data) throws -> ValidationResult {
        ...
        do {
            ...
            if tariff.countryCode.isEmpty {
                ...
                errors.append(.invalidValue(field: "country_code", reason: "Invalid ISO 3166-1 alpha-2 country code"))
            }
    ...
    private func validateTimeRestrictions(_ restrictions: TariffRestrictions, elementIndex: Int, errors: inout [ValidationError]) {
    ...
    private func validatePowerRestrictions(_ restrictions: TariffRestrictions, elementIndex: Int, errors: inout [ValidationError]) {
    ...
    private func validateDurationRestrictions(_ restrictions: TariffRestrictions, elementIndex: Int, errors: inout [ValidationError]) {
